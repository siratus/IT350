...
<div id="centerit">
  ...
  <div class = "wrapper">
    <div class="responsive">
      <div class="gallery">
          <img src="taro.png" width="300" height="200">
        <div class="desc">Taro Boba</div>
...
<div class = "wrapper">
    <div class="responsive">
      <div class="gallery">
          <img src="honeydew.png" width="600" height="400">
        <div class="desc">Honeydew Boba</div>
         <button class="button" type="submit">Add to Cart</button>
      </div>
      </div>
    </div>
...
<div class = "wrapper">
    <div class="responsive">
      <div class="gallery">
          <img src="mango.png" width="600" height="400">
        <div class="desc">Mango Boba</div>
         <button class="button" type="submit">Add to Cart</button>
      </div>
      </div>
    </div>
